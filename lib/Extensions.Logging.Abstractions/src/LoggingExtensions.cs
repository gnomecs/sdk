...
namespace Gnome.Extensions.Logging;
...
public static class LoggingExtensions
{
        ...
        [CallerLineNumber] int sourceLineNumber = 0)
    {
        ...
        log.LogTrace(
            "{MemberName} start in file {SourceFilePath} on Line {SourceLineNumber}.",
            memberName,
            sourceFilePath,
            sourceLineNumber);
    }
        ...
        [CallerLineNumber] int sourceLineNumber = 0)
    {
        ...
        log.LogTrace(
            "{MemberName} start in file {SourceFilePath} on Line {SourceLineNumber}. {Message}.",
            memberName,
            sourceFilePath,
            sourceLineNumber,
            message);
        ...
        [CallerLineNumber] int sourceLineNumber = 0)
    {
        ...
        log.LogTrace(
            "{MemberName} end in file {SourceFilePath} on Line {SourceLineNumber}.",
            memberName,
            sourceFilePath,
            sourceLineNumber);
    }
        ...
        [CallerLineNumber] int sourceLineNumber = 0)
    {
        ...
        log.LogTrace(
            "{MemberName} end in file {SourceFilePath} on Line {SourceLineNumber}. {Message}.",
            memberName,
            sourceFilePath,
            sourceLineNumber,
            message);
