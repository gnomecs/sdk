...
{
    internal static OsReleaseInfo GetOsRelease()
    {
        if (RuntimeInformation.IsOSPlatform(OSPlatform.OSX))
        {
            var os = new OsReleaseInfo(OSPlatform.OSX);
        ...
        {
            var os = new OsReleaseInfo(OSPlatform.Create("MACCATALYST"));
            os.VersionCodename = GetMacOsCodeName();
            os.Id = "maccatalyst";
        ...
        {
            var os = new OsReleaseInfo(OSPlatform.Create("IOS"));
        ...
        {
            var os = new OsReleaseInfo(OSPlatform.Create("TVOS"));
            os.Id = "tvos";
            os.Name = "tvOS";
            os.IdLike = "darwin";
            os.VersionId = $"{Environment.Version.Major}.{Environment.Version.Minor}";
    ...
    private static void SetUrls(OsReleaseInfo os)
    {
