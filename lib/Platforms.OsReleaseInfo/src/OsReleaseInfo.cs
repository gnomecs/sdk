...
{
    private static readonly Lazy<OsReleaseInfo> s_lazy = new(GetOrCreate);

    private readonly Dictionary<string, string> props = new(StringComparer.OrdinalIgnoreCase);

    internal OsReleaseInfo(OSPlatform platform)
    {
        this.Platform = platform;
    }

    public static OsReleaseInfo Current => s_lazy.Value;
    ...
    internal static OsReleaseInfo GetOrCreate()
    {
        ...
        {
            var os = new OsReleaseInfo(OSPlatform.Create("Browser"));
            os.Id = "browser";
            os.Name = "Browser";
            os.Version = v.ToString();
            os.VersionId = v.ToString();
        ...
        {
            var os = new OsReleaseInfo(OSPlatform.Create("FreeBSD"));
            os.Id = "freebsd";
            os.Name = "FreeBSD";
            os.Version = v.ToString();
            os.VersionId = v.ToString();
        ...
        {
            var os = new OsReleaseInfo(OSPlatform.Create("Android"));
            os.Id = "android";
            os.Name = "Android";
            os.Version = v.ToString();
            os.VersionId = v.ToString();
...
#endif
        var uos = new OsReleaseInfo(OSPlatform.Create("Unknown"));
        uos.Id = "unknown";
        uos.Name = "Unknown";
