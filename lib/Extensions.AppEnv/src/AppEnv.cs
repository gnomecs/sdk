...
public class AppEnv : IAppEnv
{
    ...
    public AppEnv(AppEnvOptions? options = null, MicrosoftHostEnvironment? environment = null)
    {
        options ??= new AppEnvOptions();
    ...
    public static IAppEnv Current { get; set; } = new UnknownAppEnv();
